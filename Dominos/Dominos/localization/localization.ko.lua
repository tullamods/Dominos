...
--slash command help
L.ShowOptionsDesc = '옵션 메뉴를 보여줍니다.'
L.ConfigDesc = '설정 모드를 전환합니다.'

L.SetScaleDesc = '<frameList>의 비율을 설정합니다.'
L.SetAlphaDesc = '<frameList>의 불투명도를 설정합니다.'
...
L.ShowFramesDesc = '주어진 <frameList>|1을;를; 보여줍니다.'
L.HideFramesDesc = '주어진 <frameList>|1을;를; 숨김니다.'
...
--dragFrame tooltips
L.ShowConfig = '설정: <우-클릭>'
L.HideBar = '숨김: <가운데-클릭 혹은 Shift+우-클릭>'
L.ShowBar = '표시: <가운데-클릭 혹은 Shift+우-클릭>'
L.SetAlpha = '불투명도 설정(|cffffffff%d|r): <마우스휠>'

--minimap button stuff
L.ConfigEnterTip = '<좌-클릭> 설정 모드 들어가기'
L.ConfigExitTip = '<좌-클릭> 설정 모드 종료하기'
L.BindingEnterTip = '<Shift+좌-클릭> 단축키 모드 들어가기'
L.BindingExitTip = '<Shift+좌-클릭> 단축키 모드 종료하기'
L.ShowOptionsTip = '<우-클릭> 옵션 메뉴 표시'
