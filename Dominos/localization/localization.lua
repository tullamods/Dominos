...
-- fully saying "Dominos Action Bar %d Button %d" gets cut off in the default
-- bindings editor
L.ActionBarButtonDisplayName = AddonName .. " Bar %d Button %d"
...
L.ClassBarDisplayName = HUD_EDIT_MODE_STANCE_BAR_LABEL or "Class Bar"
