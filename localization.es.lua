...
L.BindingEnterTip = '<Shift-Click Izquierdo> para entrar al modo de bindeos'
L.BindingExitTip = '<Shift-Click Izquierdo> para salir del modo de bindeos'
...
Las otras acciones del vehículo son visibles en la barra de control.]]